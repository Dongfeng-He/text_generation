...
if __name__ == '__main__':
    ...
    parser.add_argument('--accumulation_steps', default=4, type=int, required=False, help='梯度累加')
    ...
    parser.add_argument('--gradient_accumulation', default=4, type=str, required=False, help='梯度积累')
