    ...
    def process_data_dict(self, data_dict):
        ...
        if len(content) > self.min_length:
            ...
            while start_point < len(passage_tokens) - self.passage_max_length:
                ...
                sample_keywords_list.append(keyword_tokens_list)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_config', default='config/model_config_history.json', type=str, required=False, help='选择模型参数')
    parser.add_argument('--tokenizer_path', default='cache/vocab_history.txt', type=str, required=False, help='选择词库')
    parser.add_argument('--raw_data_path', default='data/train_toutiao_all.json', type=str, required=False, help='原始训练语料')
    ...
    parser.add_argument('--output_dir', default='model_toutiao_all/', type=str, required=False, help='模型输出路径')
    ...
    if os.path.exists("/Volumes/移动硬盘/model/GPT2_pretrained"):
        args.fp16 = False
        args.raw_data_path = "/Volumes/移动硬盘/数据/头条历史全/train_toutiao_all.json"
